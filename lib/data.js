// Konten terpusat Beranda — marketplace properti.
export const site = {
  name: 'Beranda',
...
export const testimonials = [
  { nama: 'Rina & Doni', peran: 'Pembeli Rumah, BSD', quote: 'Prosesnya gampang banget. Dari cari, survei, sampai akad dibantu agen Beranda. Dapat rumah impian tanpa stres!' },
  { nama: 'Pak Hendra', peran: 'Investor Properti', quote: 'Listing-nya rapi dan terpercaya. Saya sudah beli 2 ruko lewat Beranda, semuanya lancar dan transparan.' },
...
export const faqs = [
  ...
  { q: 'Apakah Beranda melayani luar Jakarta?', a: 'Ya. Kami hadir di 120+ kota di seluruh Indonesia, dari Sumatra hingga Bali dan sekitarnya.' },
];
